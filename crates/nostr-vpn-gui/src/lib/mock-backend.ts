...
import { decodeInvitePayload, determineInviteImportTarget, encodeInvitePayload } from './invite-code.js'
...
export const isAutostartEnabledMock = async () => mockAutostartEnabled
