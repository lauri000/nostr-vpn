<script lang="ts">
  ...
  import type { NetworkView, ParticipantView, UiState } from './lib/types'
            ...
            <div class="row spread network-header">
              ...
              <div class="row network-actions">
                ...
                <button
                  ...
                  disabled={inactiveNetworks.length <= 1}
                  ...
                  {#each network.participants as participant}
                    <div class="item-row saved-participant-row">
                      ...
                      <button
                        ...
                        disabled={!network.localIsAdmin}
                        on:click={() => onRemoveParticipant(network.id, participant.npub)}
                      >
                        <Trash2 size={16} strokeWidth={2.2} />
                      </button>
                    </div>
