...
use self::probes::{
    CAPTIVE_PORTAL_ENDPOINTS, NAT_PMP_DEFAULT_PORT, PCP_DEFAULT_PORT, SSDP_DISCOVERY_ADDR,
    check_captive_portal_endpoint, mapping_varies_by_dest_ip, probe_nat_pmp_server,
